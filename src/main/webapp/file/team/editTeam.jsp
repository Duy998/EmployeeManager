            ...
            <form class="form-horizontal" id="add-form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" ng-model="loadteams.name" required>
                        </div>
                    </div> 
                    <div class="form-group">
                     <select name="repeatSelect" id="repeatSelect" ng-model="loadteams.getidUsers">
      					<option ng-repeat="option in users" value="{{option.id}}" >{{option.posiTion}}</option>
    				 </select>
                    </div>
                    ...
                    <div class="form-group">
                  		...
                  		<div ng-repeat="option in users">
	                  		<input type="checkbox" ng-checked="exist(option.name)" ng-model="selectd"
	                  		ng-click="toggleselectuser(option.id)" >
